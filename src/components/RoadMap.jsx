...
function RoadMap() {
  return (
    ...
    >
      <div className="flex gap-4 px-4 pt-9 sm:px-36 xl:py-14">
      ...
      <div className="xl:[h-auto] mx-auto mb-8 flex h-[700px] flex-col gap-7 bg-roadmap bg-contain bg-[center_top_-40px] bg-no-repeat px-4 xl:mt-20 xl:flex-row xl:justify-between xl:gap-10 xl:bg-none xxl:w-[1330px]">
        <div className="mr-20 mt-12 w-[254px] self-end text-right xl:m-0 xl:self-auto xl:text-left xxl:w-[360px]">
          <p className="font-bold text-[#2455EA] xl:text-xs xxl:text-base">
            H1-2024
          </p>
          <h3 className="xll:text-2xl mb-2 text-base font-bold xl:mt-10 xl:mb-6 xl:text-base">
            Foundations & Product Development
          </h3>
          <p className="mb-2 text-xs xl:text-xs xxl:text-base">
        ...
        <div className="ml-20 w-[254px] self-start xl:m-0 xl:self-auto xxl:w-[360px]">
          <p className="font-bold text-[#2455EA] xl:text-xs xxl:text-base">
            H2-2023
          </p>
          <h3 className="xll:text-2xl mb-2 text-base font-bold xl:mt-10 xl:mb-6 xl:text-base">
        ...
        <div className="mr-20 w-[254px] self-end text-right xl:m-0 xl:self-auto xl:text-left xxl:w-[360px]">
          <p className="font-bold text-[#8FAECB] xl:text-xs xxl:text-base">
            2024
          </p>
          <h3 className="xll:text-2xl mb-2 text-base font-bold xl:mt-10 xl:mb-6 xl:text-base">
