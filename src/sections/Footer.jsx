...
const Footer = () => {
  ...
  return (
    <footer
      className="bg-[linear-gradient(266.42deg, #0C112C 0%, #2455EA 100%)]"
      style={{
    ...
    >
      <div className="xll:gap-32 mx-auto flex w-full flex-col items-center justify-center gap-10 px-4 py-14 xl:flex-row xl:gap-20 xl:px-[135px] xl:py-[120x] xxl:w-[1300px]">
        ...
        <div className="flex w-full flex-col gap-10 xl:flex-row xl:text-xs xxl:text-base">
          <div className="flex w-full flex-row justify-between xl:w-fit">
            ...
            <div className="flex w-[50%] flex-col items-start xl:w-[220px] xl:text-xs xxl:text-base">
              ...
              <a className="text-xs text-white xl:text-base">
                Terms of Service
              </a>
